...
describe("Reverse String Function", function() {
  it("Takes a string and outputs the string in reverse with the words in place", function() {
    expect(code.reverseMessage2(before)).toEqual(after);
  });
});

describe("Reverse String Function", function() {
  it("Takes a string and outputs the string in reverse with the words in place", function() {
    expect(code.reverseMessage3(before)).toEqual(after);
  });
});

describe("Reverse String Function", function() {
  it("Takes a string and outputs the string in reverse with the words in place", function() {
    expect(code.reverseMessage4(before)).toEqual(after);
  });
});

describe("Reverse String Function", function() {
  it("Takes a string and outputs the string in reverse with the words in place", function() {
    expect(code.reverseMessage5(before)).toEqual(after);
  });
});
